...
This step aims to produce the RNA velocity analysis of the data
...
One the loom file has been produced by the previous command, launch the following command to produce the analysis report on RNA velocity:
